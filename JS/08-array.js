...
fruits.sort(function(v1, v2) {
    //  반환 값이 0: 순번이 같다
    console.log(typeof(99999));
    if (v1 == v2) return 0;
    if (v1 < v2) return 99999;
    if (v1 > v2) return -1;
});
...
fruits.sort();
fruits.sort(function(v1, v2) {
    console.log(v2.charCodeAt(0),typeof((Number)(v2-v1)));
   return (v2).charCodeAt(0)-(v1).charCodeAt(0);
});

console.log("SORT(char):", fruits);
...
console.log("SORT(-1):", fruits);
fruits.sort(function(v1, v2) {
    console.log("active -1",v1,v2);
    return -1;
 });

console.log("SORT(-1):", fruits);
fruits = ['Banana', 'Orange', 'Apple', 'Mango'];
console.log("Origin:", fruits);
fruits.sort(function(v1, v2) {
    //  반환 값이 0: 순번이 같다
 console.log(v1,v2);
    if (v1 == v2){
        console.log("active fc 0 v1==v2",v1,v2);
        return 0;
    } 

    if (v1 < v2){
        console.log("actice -1 v1<v2",v1,v2);
        return -1;
    } 
    if (v1 > v2)
    {
...
console.log("SORT(User 0 0 -1):", fruits);